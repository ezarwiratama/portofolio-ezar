...
const socialLinks = [
  {
    ...
    subText: "@ezarwiratama",
    icon: Linkedin,
    url: "https://www.linkedin.com/in/ezarhardin",
    color: "#0A66C2",
  ...
  },
  {
    ...
    subText: "@ezarwiratama",
    icon: Instagram,
    url: "https://www.instagram.com/ezarwiratama",
    color: "#E4405F",
  ...
  },
  {
    ...
    subText: "@ezarwiratama",
    icon: Github,
    url: "https://github.com/ezarwiratama",
    color: "#ffffff",
  ...
  },
  {
    ...
    url: "https://tiktok.com/@ezpeazyyy",
    color: "black",
...
const SocialLinks = () => {
  ...
  return (
    <div className="w-full rounded-2xl mb-10">
